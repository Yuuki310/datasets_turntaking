...
def sph_to_wav(filepath):
    dirpath = "/data/group1/z40351r/datasets/data/Switchboard/data"
...
if __name__ == "__main__":
    ...
    directly = "/data/group1/z40351r/datasets/data/Switchboard"

    original_data = os.path.join(directly, "original_data")
    ...
    #モノラル変換
    paths = glob.glob(os.path.join(directly, "data/*.wav"))
